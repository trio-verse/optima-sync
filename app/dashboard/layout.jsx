...
export default function DashboardLayout({ children }) {
    ...
    useEffect(() => {
        ...
        const currentOrgId = Cookies.get("organaizationId") || Cookies.get("organizationId");
        if (currentOrgId) {
                ...
                <div className="p-6">
                    ...
                    <nav className="flex flex-col gap-1.5">
                        <button
                            ...
                            className={`flex items-center gap-3 w-full px-4 py-2.5 rounded-lg font-semibold text-sm transition text-right cursor-pointer ${activeTab === "sales"
                        ...
                        >
                            <button
                                ...
                                className={`flex items-center gap-3 w-full px-4 py-2.5 rounded-lg font-semibold text-sm transition text-right cursor-pointer ${activeTab === "clients"
                                    ? "bg-zinc-900 text-white shadow-sm"
                                    : "text-zinc-700 hover:bg-zinc-200 hover:text-zinc-900"
                                    }`}
                            >
                        ...
                        <button
                            ...
                            className={`flex items-center gap-3 w-full px-4 py-2.5 rounded-lg font-semibold text-sm transition text-right cursor-pointer ${activeTab === "marketing"
                                ? "bg-zinc-900 text-white shadow-sm"
                                : "text-zinc-700 hover:bg-zinc-200 hover:text-zinc-900"
                                }`}
                        >
                        ...
                        >
                            <button
                                ...
                                className={`flex items-center gap-3 w-full px-4 py-2.5 rounded-lg font-semibold text-sm transition text-right cursor-pointer ${activeTab === "industries"
                                    ? "bg-zinc-900 text-white shadow-sm"
                                    : "text-zinc-700 hover:bg-zinc-200 hover:text-zinc-900"
                                    }`}
                            >
                        ...
                        >
                            <button
                                ...
                                className={`flex items-center gap-3 w-full px-4 py-2.5 rounded-lg font-semibold text-sm transition text-right cursor-pointer ${activeTab === "cities"
                                    ? "bg-zinc-900 text-white shadow-sm"
                                    : "text-zinc-700 hover:bg-zinc-200 hover:text-zinc-900"
                                    }`}
                            >
                        ...
                        >
                            <button
                                ...
                                className={`flex items-center gap-3 w-full px-4 py-2.5 rounded-lg font-semibold text-sm transition text-right cursor-pointer ${activeTab === "channels"
                                    ? "bg-zinc-900 text-white shadow-sm"
                                    : "text-zinc-700 hover:bg-zinc-200 hover:text-zinc-900"
                                    }`}
                            >
                        ...
                        <button
                            ...
                            className={`flex items-center gap-3 w-full px-4 py-2.5 rounded-lg font-semibold text-sm transition text-right cursor-pointer ${activeTab === "settings"
                                ? "bg-zinc-900 text-white shadow-sm"
                                : "text-zinc-700 hover:bg-zinc-200 hover:text-zinc-900"
                                }`}
                        >
                            ...
                            <div className="flex flex-col gap-1 pr-6 pl-2 transition-all duration-200">
                                <div>
                                    <Link
                                        ...
                                        className={`flex items-center gap-2 w-full px-4 py-2 rounded-lg text-xs font-semibold transition text-right ${activeTab === "profile"
                                ...
                                <div>
                                    <Link
                                        ...
                                        className={`flex items-center gap-2 w-full px-4 py-2 rounded-lg text-xs font-semibold transition text-right ${activeTab === "Logo"
                                            ? "bg-blue-100 text-blue-700 font-bold"
                                            : "text-zinc-600 hover:bg-zinc-200 hover:text-blue-600"
                                            }`}
                                    >
