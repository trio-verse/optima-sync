"use client";
import { getMembers, createMember, deleteMember, updateMember } from "@/app/actions/services/membersAction";
import { Users, Sparkles, Plus, UserCheck, ShieldCheck, Search, Trash2, Mail, Pencil, X, AlertCircle } from "lucide-react";
            ...
            <div className="w-full max-w-6xl flex flex-col gap-8">
                ...
                <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs flex flex-col gap-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-base font-extrabold text-slate-900">Add New Member</h2>
                            <p className="text-slate-500 text-xs font-medium">Enter member email and select their role.</p>
                        </div>
                    </div>
                                        ...
                                        return (
                                            <tr key={member.id} className="hover:bg-slate-50/60 transition-colors">
                                                ...
                                                <td className="py-4 px-6">
                                                    <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-extrabold capitalize border ${getRoleBadge(member.role)}`}>
                                                        {member.role}
                                                    </span>
                                                </td>
                ...
                {isModalOpen && (
                    <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4">
                        <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl flex flex-col gap-6 animate-in fade-in zoom-in-95 duration-150 border border-slate-100 relative">
                            ...
                            <h3 className="text-lg font-bold text-slate-900">Update Member Role</h3>
