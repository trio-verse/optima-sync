...
export default function RegisterForm() {
  ...
  return (
    <div
      aria-description="register-container"
      className="min-h-lvh flex justify-center items-center bg-gradient-to-tr from-slate-50 via-blue-50/30 to-zinc-100 p-4"
    >
      <div
      ...
      >
        <div className="text-center w-full mb-6">
          ...
          <p className="text-zinc-500 text-xs px-2 leading-relaxed font-medium">
            Now you do not need a password to access the ERP System. Just enter
            your email to verify your secure session.
          </p>
        </div>
